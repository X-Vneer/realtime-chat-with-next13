...
const ChatContainer = ({
  ...
  return (
    <>
      <div
        id="messages"
        className="px-4 py-2 h-full flex flex-col  justify-center  pt-[70px]   overflow-y-auto scrollbar-thumb-rounded scrollbar-thumb-blue scrollbar-track-blue-lighter scrollbar-w-2"
      >
              ...
              >
                <div className={cn("flex", { "justify-end": userMessage })}>
                  ...
                  >
                    <span
                      className={cn(
                        "p-4 py-2 rounded-lg  inline-flex  items-center ",
                        userMessage
                          ? "bg-[#222] text-white"
                    ...
                    >
                      ...
                      {message.isLoading ? (
                        <Loader2 className="mx-2 h-4 w-4 shrink-0 animate-spin" />
                      ) : null}
                      {message.isError ? (
                        <AlertTriangle className="h-4 w-4 mx-3" />
                      ) : null}
                    </span>
                  </div>
                </div>
